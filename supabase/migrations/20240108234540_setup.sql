...
AS $$
DECLARE
  project_url TEXT := 'https://gtdaequaxjgbvsxfzmrz.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imd0ZGFlcXVheGpnYnZzeGZ6bXJ6Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3MDYzNDQwNSwiZXhwIjoyMDg2MjEwNDA1fQ.RfwOQ63PPIWlQ0i60JzhuKvoLcjzROb5pbgHm2_XumQ'; -- full access needed for http request to storage
